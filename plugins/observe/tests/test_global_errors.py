...
_writer = importlib.import_module("plugins.observe.backend.collector")
_collector = importlib.import_module("plugins.observe.backend.collector")
_writermod = importlib.import_module("plugins.observe.backend.writer")
